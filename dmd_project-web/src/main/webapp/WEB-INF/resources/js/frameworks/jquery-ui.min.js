...
(function (e) {
    ...
    }), e.ui.autocomplete, e.extend(e.ui, {datepicker: {version: "1.11.1"}});
    var d;
    ...
    }, e.datepicker = new n, e.datepicker.initialized = !1, e.datepicker.uuid = (new Date).getTime(), e.datepicker.version = "1.11.1", e.datepicker, e.widget("ui.tabs", {
        version: "1.11.1",
        delay: 300,
        options: {
            active: null,
